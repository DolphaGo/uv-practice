...
class AgentTaskManager(InMemoryTaskManager):
    ...
    def __init__(self, agent: CodeEvalAgent):
        super().__init__()
        self.agent = agent
    ...
    async def _stream_generator(
        ...
        print("AgentTaskManager: stream_generator")
    ...
    def _validate_request(
        ...
        if not utils.are_modalities_compatible(
                task_send_params.acceptedOutputModes, CodeEvalAgent.SUPPORTED_CONTENT_TYPES
        ):
            logger.warning(
                "Unsupported output mode. Received %s, Support %s",
                task_send_params.acceptedOutputModes,
                CodeEvalAgent.SUPPORTED_CONTENT_TYPES,
            )
